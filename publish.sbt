...
pomExtra := <url>https://github.com/InnovaCo/service-config</url>
  <licenses>
    <license>
      <name>BSD-style</name>
  ...
  <scm>
    <url>git@github.com:InnovaCo/service-config.git</url>
    <connection>scm:git:git@github.com:InnovaCo/service-config.git</connection>
  </scm>
  <developers>
    <developer>
      <id>InnovaCo</id>
