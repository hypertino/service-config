...
pomExtra :=
  <url>https://github.com/hypertino/service-config</url>
    <licenses>
      <license>
        <name>BSD-style</name>
    ...
    <scm>
      <url>git@github.com:hypertino/service-config.git</url>
      <connection>scm:git:git@github.com:hypertino/service-config.git</connection>
    </scm>
    <developers>
      <developer>
        <id>maqdev</id>
